...
from codes.tensor_model import Model
...
model1 = Model(dws, input_size=[28, 28], class_num=8, learning_rate=0.0007,
               steps=60000, batch_size=128, drop_out=0.8)
# Set weights
...
model1.train(sess1, 'main')
model1.save_model(sess1, './model/model1/model1.ckpt')
# prediction_main = model1.predict(sess1, 'main')
sess1.close()
...
model2 = Model(dws, input_size=[45, 90], class_num=5, learning_rate=0.001,
               steps=100000, batch_size=128, drop_out=0.75)
# Set weights
...
model2.train(sess2, 'sub')
model2.save_model(sess2, './model/model2/model2.ckpt')
# prediction_sub = model2.predict(sess2, 'sub')
sess2.close()
